...
<video width"320" height="240" controls loop="" autoplay="">
    <source src="https://github.com/user-attachments/assets/d998d3c2-f5c2-4fda-9bde-66f267d56470">
</video>
</div>
...
- [Wallpaper Engine](https://store.steampowered.com/app/431960/Wallpaper_Engine/): Aplicación para crear y utilizar fondos de pantalla animados en Windows.
- [Streamlabs](https://streamlabs.com/): Herramientas y servicios para streamers, incluyendo software de streaming, alertas, donaciones, y más.
- [Chatterino](https://chatterino.com/): Cliente de chat avanzado para Twitch, diseñado para mejorar la experiencia de chat en streams.
- [Davinci Resolve](https://www.blackmagicdesign.com/products/davinciresolve/): Software de edición de video profesional, conocido por sus capacidades de corrección de color y edición no lineal.
- [Adobe](https://www.adobe.com/es/): Gama de software de Adobe, incluyendo Photoshop, Illustrator, Premiere Pro, entre otros.
- [Cinema4D](https://www.maxon.net/es/products/cinema-4d/overview): Software de animación 3D, gráficos en movimiento, modelado, simulación y renderizado.
- [SnapCamera](https://snapcamera.snapchat.com/): Aplicación que trae los filtros de Snapchat a tu cámara web para videollamadas y streaming.
- [aTube Catcher](https://www.atube.me/es/): Software para descargar videos de sitios web sociales como YouTube, así como para convertir formatos de video y audio.
- [Shutter Encoder](https://www.shutterencoder.com/en/): Software de conversión de video y audio, con una amplia gama de formatos y opciones de codificación.
- [BMIDI Virtual MIDI SDK](https://www.bome.com/products/bmidi): BMIDI is a cross platform SDK for developers or manufacturers who want to add virtual MIDI ports to their application or driver. It is used for quick and easy virtual port support in their software.
- [Touch OSC](https://hexler.net/products/touchosc): Aplicación que convierte dispositivos móviles en controladores MIDI táctiles personalizables.
- [Descript](https://www.descript.com/): Herramienta de edición de audio y video que permite editar media como si fuera un documento de texto.
- [IntelliJ](https://www.jetbrains.com/idea/): IDE de JetBrains para desarrollo en Java, Kotlin y otros lenguajes, conocido por sus características avanzadas y soporte para múltiples frameworks.
